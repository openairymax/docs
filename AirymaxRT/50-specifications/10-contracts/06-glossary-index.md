...
**最新**: 2026-06-09
**状态**: 维护中
**路径**: OpenAirymax/Docs/50-specifications/10-contracts/06-glossary-index.md
---
...
|--------|---------|--------------|------|
| AGENTRT_EOK | 0 | 0x0000 | 成功 |
| AGENTRT_EINVAL | -1 | 0x0003 | 参数无效 |
| AGENTRT_ENOMEM | -2 | 0x0002 | 内存不足 |
| AGENTRT_ENOENT | -5 | 0x0004 | 资源不存在 |
| AGENTRT_EPERM | -4 | 0x0005 | 权限不足 |
| AGENTRT_ETIMEOUT | -11 | 0x0006 | 操作超时 |
