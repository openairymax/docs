...
```c
// agentrt/daemons/common/include/svc_common.h (第 18 行)
#include "logger.h"  // 来自 agentrt/commons/utils/observability
```

**关键点**:
- `agentrt/daemons/` 下的所有用户态服务层进程通过 `svc_common.h` 复用 `agentrt/commons/utils/observability` 中的日志接口
...
```c
// C 语言服务端 (agentrt/daemons/tool_d/src/main.c)
...
- [服务公共接口](agentrt/daemons/common/include/svc_common.h)
