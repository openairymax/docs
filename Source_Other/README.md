...
| 资源 | 描述 | 用途 | 状态 |
|------|------|------|------|
| `Airymax-desktop-preview.gif` | Desktop 桌面应用预览动图 | 文档插图、README 展示 | 不入库（大文件） |

## 资源获取

Desktop 桌面应用的预览素材由 `products/desktop` 仓库生成。
...
本目录下所有资源文件遵循 AGPL-3.0-or-later OR Apache-2.0 双许可证，版权所有 SPHARX Ltd.
