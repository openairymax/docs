...
|------|----------------|--------------|------|
| **0.1.1** | 文档体系完成（~79 文档 P0 基线 / ~85 文档工程基线 / ~140 文档全量展开，不含内核/OS 实施；文档数与 0.1.1 工时口径见 03-resource-estimation.md §1.1/§3.1） | 全部三大支柱（奠基 + 29 仓拆分 + 生产就绪） | ~80h |
...
> **文档结束** | 路线图模块 v1.0.1 | 共 7 文档 | 维护者：开源极境工程与规范委员会 | 路线图是"什么时候写什么代码"的总纲
