...
- **文档工时**——19 个文档模块共约 140 篇文档的撰写、审查与定稿工时（02-milestones-and-timeline.md §6.1 口径；本表 §3.1 对 50-190 十五个文档模块精确求和为 137 篇）
...
| **总计** | **~2,750h** | **~126 天** | 含 14% 风险缓冲（以 02-milestones-and-timeline.md 关键路径 126 天为准） |
...
| **关键路径合计** | **~2,370** | **~140** | 含并行重叠，实际工期 126 天（18 周，以 02-milestones-and-timeline.md 为准） |

### 6.3 关键路径甘特图

```mermaid
gantt
    title agentrt-linux 1.0.1 关键路径（126 天 = 18 周）
    dateFormat  YYYY-MM-DD
    axisFormat  %m-%d
...
- **关键路径工期**：~18 周（126 天），从 M0 启动到 M8 完成（对齐 02-milestones-and-timeline.md §7.1）
