...
| 6 | [SS] CLT_run 签名 | `agentrt_clt_run(ctx)` | 语义等价，实现独立 | ✅ PASS 语义同源 |
| 7 | [SS] notify_phase 签名 | `agentrt_clt_notify_phase(ctx, phase)` | 语义等价 | ✅ PASS 语义同源 |
| 8 | [SS] thinkdual_switch 签名 | `agentrt_thinkdual_switch(ctx, mode)` | 语义等价 | ✅ PASS 语义同源 |
| 9 | [SS] llm_scheduler_submit 签名 | `agentrt_llm_scheduler_submit(req)` | 语义等价 | ✅ PASS 语义同源 |
| 10 | [SS] query_phase 签名 | `agentrt_clt_query_phase(ctx)` | 语义等价 | ✅ PASS 语义同源 |
