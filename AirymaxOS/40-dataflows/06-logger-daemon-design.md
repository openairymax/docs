...
| 配置文件 | `/etc/agentrt/logger_d.conf` | A-UCS 管理的 YAML/TOML 配置（JSON 仅用于 IPC payload） |
...
Logger Daemon 支持三级过滤，由 A-UCS 配置管理（`/etc/agentrt/logger_d.conf`，YAML/TOML 格式）：
...
© 2025-2026 SPHARX Ltd. All Rights Reserved. | Logger Daemon 详细设计 | v1.0.1 | 2026-07-21
