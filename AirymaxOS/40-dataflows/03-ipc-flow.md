...
| 7 | [SS] ring_create 签名 | `agentrt_ipc_ring_create()` | 语义同源 `io_uring_setup()` | ✅ PASS 语义同源 |
| 8 | [SS] ring_enter 签名 | `agentrt_ipc_ring_enter()` | 语义同源 `io_uring_enter()` | ✅ PASS 语义同源 |
| 9 | [SS] submit_batch 签名 | `agentrt_ipc_submit_batch()` | 语义同源 `io_submit_sqes()` | ✅ PASS 语义同源 |
| 10 | [SS] register 签名 | `agentrt_ipc_register()` | 语义同源 `io_uring_register()` | ✅ PASS 语义同源 |
