...
| 边界 | 共享策略 | 说明 |
|------|---------|------|
| agentrt ↔ agentrt-liunx | [SC] 共享契约层 6 个头文件 | 唯一的代码共享通道 |
| agentrt-liunx ↔ Linux 6.6 基线 | 仅技术参考，不共享代码 | 参考主流 Linux 工程思想与实现方式，不共享代码 |
...
以下 上游 Linux 6.6 不含的特性不移植到 agentrt-liunx（2026-07-07 用户决策）：
