...
│
├── 10-coding-style/                   # 编码规范子目录（原 50-specifications/30-coding-standard/）
│   ├── README.md                      # 编码规范总览与导航
...
│
├── 20-contracts/                      # 契约规范子目录（原 50-specifications/10-contracts/）
│   ├── README.md                      # 契约规范总览与导航
│   ├── ipc_protocol_contract.md       # IPC 协议契约
│   ├── logging_contract.md           # 日志契约
│   └── syscall_api_contract.md       # 系统调用 API 契约
│
├── 30-runtime-interfaces/             # 运行时接口子目录（原 50-specifications/20-are-standards/）
...
│
├── 40-integration/                    # 集成规范子目录（原 50-specifications/50-integration/）
│   ├── README.md                      # 集成规范总览与导航
│   └── agentrt_integration.md         # agentrt 集成规范
│
├── 50-project-erp/                    # 项目工程管理子目录（原 50-specifications/70-project-erp/）
...
> **迁移说明**：`10-coding-style/` 至 `50-project-erp/` 五个子目录由原 `50-specifications/` 目录迁移而来（2026-07-08 完成迁移，原 `50-specifications/` 目录已删除）。`10-terminology.md` 已提升至 `docs/AirymaxOS/` 顶层。

### 2.1 章节定位

| 章节          | 核心问题                                                                | 来源                                                                    |
| ----------- | ------------------------------------------------------------------- | --------------------------------------------------------------------- |
| 01 代码规范     | "代码该怎么写"——命名、函数、注释、类型、错误处理的强制规则                                     | Linux `coding-style.rst`（1271 行）+ Airymax `30-coding-standard/`（15 文件）   |
...
- `docs/AirymaxOS/10-terminology.md`（术语规范，已提升至顶层）
