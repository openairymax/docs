...
agentrt-linux 工程标准由 5 个主题章节（01-05）+ 2 个治理章节（06-07）+ 1 个合规性检查章节（08）+ 1 个许可证策略（09）+ 6 个扩展专题文档（60/70/80/100/110/120）构成，共 15 个子文档（含本 README 共 16 文档）：
...
├── 09-license-strategy.md             # 许可证策略（AGPL-3.0 + Apache-2.0 双许可证）
│
...
│
├── 20-contracts/                      # 契约规范子目录（原 Capital_Specifications/agentos_contract/）
│   ├── README.md                      # 契约规范总览与导航
...
> - **子目录（10-50）**：5 个专项规范子目录，由原 `Capital_Specifications/` 迁移而来
> - **扩展文档（60-120）**：6 个专题深度文档，对核心章节的特定主题进行穷尽式展开

> **迁移说明**：`10-coding-style/` 至 `50-project-erp/` 五个子目录由原 `Capital_Specifications/` 目录迁移而来（2026-07-08 完成迁移，原 `Capital_Specifications/` 目录已删除）。`TERMINOLOGY.md` 已提升至 `docs/AirymaxOS/` 顶层。
...
- 完成 50-engineering-standards/ 全部 16 文档（含本 README + 00-09 核心 10 文档 + 60-120 扩展 6 文档，含 08-compliance-checklist.md）
...
> **文档结束** | 共 16 文档（含本 README + 00-09 核心 10 文档 + 60-120 扩展 6 文档）| 0.1.1 版本 P0 优先完成
