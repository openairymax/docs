...
- agentrt 用户态契约：定义应用层组件间的交互协议（HTTP/WS/Stdio 网关、JSON-RPC 2.0、Agent 契约、Skill 契约），位于 `docs/AirymaxRT/Capital_Specifications/agentrt_contract/`。
...
- [agentrt 用户态契约](../../../AirymaxRT/Capital_Specifications/agentrt_contract/protocol_contract.md)
