...
**指标采集来源**：
- 所有指标由 macro_superv + audit_d 通过 Prometheus exporter 暴露（`/metrics` 端点，详见 [03-monitoring.md](03-monitoring.md)）。
...
| **macro_superv** | 接收 remediation 完成回调，更新 Agent 状态 | 内置 |
