...
AirymaxOS 工程标准与 agentrt 工程标准遵循 IRON-9 v2 同源且部分代码共享原则：
...
AirymaxOS 开发策略以三大支柱（工程标准 + 架构设计 + 开发治理）为骨架，以 9 个 Part（P0 七部分 + P1 两部分）为执行单元，以 9 个里程碑（M0-M8）为节奏节点，以五维正交 24 原则为设计哲学，以 IRON-9 v2 同源且部分代码共享原则处理与 agentrt 的协同关系。
...
- `docs-closed/0.1.1工程标准规范手册.md` — 17 类规则编号体系（v28.0，含 IRON-9 v2 同源且部分代码共享）
