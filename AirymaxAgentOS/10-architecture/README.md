...
| 与 agentrt 同源但独立 | Airymax 同源性 | agentrt 是跨平台用户态运行时，AirymaxOS 是 Linux 专属优化 |
...
AirymaxOS 与 agentrt 共享 Airymax 设计理念，但**不共享代码**。两者在多个核心模块上存在同源映射关系。
