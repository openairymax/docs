 ...
 * 
 * 本文件包含以下许可证代码：
 * 1. 主要部分: Apache-2.0 (Airymax 自研代码)
...
| 作者信息 | 可选 | 创建者、维护者、联系方式 | `@author Airymax Team` |
...
8. **Airymax 架构设计原则**: [ARCHITECTURAL_PRINCIPLES.md](../../ARCHITECTURAL_PRINCIPLES.md)
9. **Airymax 统一术语表**: [TERMINOLOGY.md](../TERMINOLOGY.md)
