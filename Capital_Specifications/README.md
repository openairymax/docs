...
theoretical_basis: "工程两论、五维正交系统、Thinkdual 认知双思系统"
...
AgentOS 技术规范体系是项目开发、测试、部署和维护的权威标准。本规范体系基于工程控制论、系统工程和 Thinkdual 认知双思系统，确保系统的稳定性、安全性和可演进性。
...
集成标准定义了 AgentOS 与外部系统的交互规范、生态合作和技术贡献路径。
...
| 文档 | 版本 | 状态 | 描述 |
|------|------|------|------|
| [TERMINOLOGY.md](TERMINOLOGY.md) | v1.3.0 | ✅ 生产就绪 | AgentOS 统一术语定义、交叉引用 |
...
| 版本 | 日期 | 作者 | 变更说明 |
|------|------|------|----------|
| Doc V2.2 | 2026-06-08 | AgentOS 规范委员会 | 统一版本号至 v1.3.0，新增双错误码体系说明，新增 Rust/Go 编码风格与安全编码标准 |
| Doc V2.1 | 2026-06-07 | AgentOS 规范委员会 | 修正所有失效链接，新增集成标准章节，整理散落文件 |
